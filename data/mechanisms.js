...
const MEDIUM_MECHANISMS = [
  ...
  ,{
    ...
    emoji: "⚗️",
    clue: "Category: chemistry. Tags: SN2, nucleophile, inversion. A one-step reaction where an attacking group approaches 180° opposite the leaving group — the carbon centre flips like an umbrella in the wind.",
    diagram: '<div class="mech-diagram"><svg viewBox="0 0 460 155" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block"><defs><marker id="sn2a" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#0F7B6C"/></marker><marker id="sn2b" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#C4412A"/></marker></defs><text x="4" y="14" font-size="10" fill="#6B6760" font-family="monospace">REACTANT</text><text x="8" y="90" font-size="13" fill="#0F7B6C" font-weight="bold" font-family="monospace">Nu:</text><line x1="42" y1="86" x2="74" y2="86" stroke="#0F7B6C" stroke-width="2" marker-end="url(#sn2a)"/><circle cx="90" cy="86" r="15" fill="#FDF0DC" stroke="#C4720A" stroke-width="2"/><text x="84" y="91" font-size="12" font-family="monospace" fill="#C4720A">C</text><line x1="105" y1="86" x2="134" y2="86" stroke="#C4412A" stroke-width="2" marker-end="url(#sn2b)"/><text x="137" y="91" font-size="12" fill="#C4412A" font-family="monospace">Br</text><line x1="90" y1="71" x2="90" y2="48" stroke="#1A1A18" stroke-width="1.5"/><text x="83" y="44" font-size="11" font-family="monospace">CH3</text><line x1="78" y1="96" x2="61" y2="112" stroke="#1A1A18" stroke-width="1.5" stroke-dasharray="4,2"/><text x="51" y="126" font-size="11" font-family="monospace">H</text><line x1="102" y1="96" x2="118" y2="112" stroke="#1A1A18" stroke-width="1.5"/><text x="120" y="126" font-size="11" font-family="monospace">H</text><text x="160" y="91" font-size="20" fill="#6B6760">-&gt;</text><text x="192" y="14" font-size="10" fill="#6B6760" font-family="monospace">TRANSITION STATE</text><text x="192" y="90" font-size="11" fill="#0F7B6C" font-family="monospace">Nu</text><line x1="207" y1="86" x2="224" y2="86" stroke="#0F7B6C" stroke-width="1.5" stroke-dasharray="4,3"/><circle cx="240" cy="86" r="15" fill="#FDF0DC" stroke="#C4720A" stroke-width="2" stroke-dasharray="5,3"/><text x="234" y="91" font-size="12" font-family="monospace" fill="#C4720A">C</text><text x="228" y="68" font-size="10" fill="#C4720A" font-family="monospace">d-</text><line x1="255" y1="86" x2="272" y2="86" stroke="#C4412A" stroke-width="1.5" stroke-dasharray="4,3"/><text x="275" y="90" font-size="11" fill="#C4412A" font-family="monospace">Br</text><line x1="240" y1="71" x2="240" y2="50" stroke="#1A1A18" stroke-width="1.5"/><text x="233" y="46" font-size="11" font-family="monospace">CH3</text><text x="315" y="91" font-size="20" fill="#6B6760">-&gt;</text><text x="348" y="14" font-size="10" fill="#6B6760" font-family="monospace">PRODUCT (inverted)</text><circle cx="380" cy="86" r="15" fill="#D4EDE9" stroke="#0F7B6C" stroke-width="2"/><text x="374" y="91" font-size="12" font-family="monospace" fill="#0F7B6C">C</text><line x1="395" y1="86" x2="418" y2="86" stroke="#0F7B6C" stroke-width="2"/><text x="420" y="91" font-size="12" fill="#0F7B6C" font-family="monospace">Nu</text><line x1="380" y1="71" x2="380" y2="50" stroke="#1A1A18" stroke-width="1.5"/><text x="373" y="46" font-size="11" font-family="monospace">CH3</text><line x1="368" y1="97" x2="352" y2="112" stroke="#1A1A18" stroke-width="1.5"/><text x="342" y="126" font-size="11" font-family="monospace">H</text><line x1="392" y1="97" x2="406" y2="112" stroke="#1A1A18" stroke-width="1.5" stroke-dasharray="4,2"/><text x="408" y="126" font-size="11" font-family="monospace">H</text><text x="340" y="148" font-size="10" fill="#C4412A" font-family="monospace">Walden inversion</text></svg></div>',
    steps: [
      "The nucleophile (Nu, e.g. OH- or CN-) approaches the electrophilic carbon from the back — exactly 180 degrees opposite the leaving group (e.g. Br-).",
      "In a single concerted step, the Nu-C bond forms as the C-Br bond breaks simultaneously. The carbon passes through a flat pentacoordinate transition state — like an umbrella mid-flip.",
      "The three remaining substituents invert through the plane — Walden inversion. Product has opposite stereochemistry. Rate = k[Nu][substrate] — bimolecular, hence SN2."
    ],
    summary: "SN2: one concerted step, backside attack, Walden inversion, rate = k[Nu][RX]. Favoured at primary carbons — tertiary too hindered.",
    clinical: "Alkylating chemotherapy agents (cyclophosphamide, melphalan) use SN2-like chemistry to cross-link cancer cell DNA strands, blocking replication and killing the tumour cell.",
    memory_hook: "SN2 is a drive-by — the nucleophile sweeps in from behind in one smooth move. The carbon flips like an umbrella caught in the wind. No waiting, no intermediate.",
    solution: "SN2 proceeds via a concerted bimolecular mechanism: nucleophilic attack anti-periplanar to the leaving group through a trigonal bipyramidal transition state, with simultaneous C-Nu bond formation and C-LG bond breaking, resulting in complete inversion of configuration (Walden inversion). Rate = k[Nu][RX]."
  },
  {
    id: "m14",
    ...
    emoji: "⚗️",
    clue: "Category: chemistry. Tags: carbonyl, hydride, reduction. A borohydride reagent delivers a hydride ion to the electrophilic carbonyl carbon, converting a ketone into an alcohol.",
    diagram: '<div class="mech-diagram"><svg viewBox="0 0 440 145" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block"><defs><marker id="bha" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#0F7B6C"/></marker><marker id="bhb" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#C4412A"/></marker></defs><text x="4" y="13" font-size="10" fill="#6B6760" font-family="monospace">Ketone + NaBH4</text><text x="6" y="68" font-size="13" font-family="monospace">CH3</text><line x1="38" y1="64" x2="58" y2="64" stroke="#1A1A18" stroke-width="2"/><circle cx="70" cy="64" r="12" fill="#FDF0DC" stroke="#C4720A" stroke-width="1.5"/><text x="64" y="69" font-size="12" font-family="monospace" fill="#C4720A">C</text><line x1="70" y1="52" x2="70" y2="34" stroke="#C4412A" stroke-width="2"/><line x1="75" y1="52" x2="75" y2="34" stroke="#C4412A" stroke-width="2"/><text x="65" y="30" font-size="12" font-family="monospace" fill="#C4412A">O</text><text x="80" y="28" font-size="9" fill="#C4412A" font-family="monospace">d-</text><text x="65" y="80" font-size="9" fill="#C4720A" font-family="monospace">d+</text><line x1="82" y1="64" x2="102" y2="64" stroke="#1A1A18" stroke-width="2"/><text x="104" y="69" font-size="13" font-family="monospace">CH3</text><text x="58" y="115" font-size="13" font-family="monospace" fill="#0F7B6C" font-weight="bold">H-</text><line x1="68" y1="107" x2="70" y2="79" stroke="#0F7B6C" stroke-width="2" marker-end="url(#bha)"/><path d="M 70 53 Q 63 41 70 31" stroke="#C4412A" stroke-width="1.5" fill="none" stroke-dasharray="3,2" marker-end="url(#bhb)"/><text x="145" y="68" font-size="16" fill="#6B6760">-&gt;</text><text x="168" y="13" font-size="10" fill="#6B6760" font-family="monospace">Alkoxide</text><text x="168" y="68" font-size="13" font-family="monospace">CH3</text><line x1="200" y1="64" x2="218" y2="64" stroke="#1A1A18" stroke-width="2"/><circle cx="230" cy="64" r="12" fill="#E8E4F8" stroke="#4A3BAA" stroke-width="1.5"/><text x="224" y="69" font-size="12" font-family="monospace" fill="#4A3BAA">C</text><line x1="230" y1="52" x2="230" y2="34" stroke="#4A3BAA" stroke-width="2"/><text x="221" y="30" font-size="12" font-family="monospace" fill="#4A3BAA">O-</text><line x1="230" y1="76" x2="230" y2="94" stroke="#0F7B6C" stroke-width="2"/><text x="224" y="108" font-size="12" font-family="monospace" fill="#0F7B6C">H</text><line x1="242" y1="64" x2="260" y2="64" stroke="#1A1A18" stroke-width="2"/><text x="262" y="69" font-size="13" font-family="monospace">CH3</text><text x="295" y="56" font-size="12" fill="#6B6760">+H2O</text><text x="300" y="70" font-size="15" fill="#6B6760">-&gt;</text><text x="328" y="13" font-size="10" fill="#6B6760" font-family="monospace">Alcohol</text><text x="328" y="68" font-size="13" font-family="monospace">CH3</text><line x1="360" y1="64" x2="376" y2="64" stroke="#1A1A18" stroke-width="2"/><circle cx="388" cy="64" r="12" fill="#D4EDE9" stroke="#0F7B6C" stroke-width="1.5"/><text x="382" y="69" font-size="12" font-family="monospace" fill="#0F7B6C">C</text><line x1="388" y1="52" x2="388" y2="34" stroke="#0F7B6C" stroke-width="2"/><text x="380" y="30" font-size="12" font-family="monospace" fill="#0F7B6C">OH</text><line x1="388" y1="76" x2="388" y2="94" stroke="#1A1A18" stroke-width="2"/><text x="382" y="108" font-size="12" font-family="monospace">H</text><line x1="400" y1="64" x2="418" y2="64" stroke="#1A1A18" stroke-width="2"/><text x="420" y="69" font-size="12" font-family="monospace">CH3</text><text x="4" y="135" font-size="10" fill="#6B6760" font-family="monospace">H- attacks d+ carbon, C=O pi bond breaks, O gets electrons (O-), protonation gives alcohol.</text></svg></div>',
    steps: [
      "NaBH4 delivers a hydride ion (H-) — a nucleophile. It attacks the electrophilic (d+) carbonyl carbon, driven by the electronegativity of oxygen withdrawing electron density.",
      "The C=O pi bond breaks heterolytically. Oxygen takes both electrons and becomes O- (alkoxide). Carbon is now tetrahedral (sp3) with a new C-H bond.",
      "Aqueous workup protonates the alkoxide (O- + H2O gives OH) to give the product. Ketones give secondary alcohols; aldehydes give primary alcohols by the same route."
    ],
    summary: "NaBH4: H- attacks carbonyl carbon, C=O pi bond breaks, alkoxide formed, protonation gives alcohol. Ketones to secondary alcohols; aldehydes to primary alcohols.",
    clinical: "Biological NADPH acts as the cellular hydride donor in the same way — carbonyl reductase enzymes use NADPH to reduce drug ketone groups in the liver (e.g. cortisone to active cortisol).",
    memory_hook: "H- is electron-rich, carbonyl carbon is electron-poor — opposites attract. H- dives in, oxygen grabs the electrons, add water and you have an alcohol.",
    solution: "Nucleophilic addition of hydride (H- from NaBH4) to the carbonyl pi* LUMO breaks the C=O pi bond, generating a tetrahedral alkoxide intermediate. Aqueous workup protonates O- to give the alcohol. Net: C=O reduced to CHOH. Ketones give secondary, aldehydes give primary alcohols."
  }
];
...
const HARD_MECHANISMS = [
  ...
  ,{
    ...
    tags: ["benzene", "nitration", "EAS", "nitronium ion", "arenium ion"],
    emoji: "⚗️",
    clue: "Tags: benzene, nitration, EAS, nitronium ion, arenium ion. Mixed acid generates a potent electrophile that attacks benzene — the ring recovers by expelling a proton rather than adding across the double bond, preserving aromaticity.",
    diagram: '<div class="mech-diagram"><svg viewBox="0 0 500 185" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block"><defs><marker id="ea1" markerWidth="7" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#0F7B6C"/></marker><marker id="ea2" markerWidth="7" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#C4412A"/></marker></defs><text x="4" y="13" font-size="10" fill="#6B6760" font-family="monospace">Step 1: HNO3 + H2SO4 gives NO2+ (nitronium ion)</text><text x="4" y="27" font-size="11" font-family="monospace" fill="#1A1A18">HNO3 + H2SO4</text><text x="110" y="27" font-size="13" fill="#6B6760"> -&gt; </text><text x="128" y="27" font-size="12" font-family="monospace" fill="#C4412A" font-weight="bold">NO2+</text><text x="162" y="27" font-size="10" font-family="monospace" fill="#6B6760"> + HSO4- + H2O</text><text x="4" y="45" font-size="10" fill="#6B6760" font-family="monospace">Step 2: NO2+ attacks benzene pi system (rate-limiting)</text><polygon points="60,92 80,78 100,92 100,118 80,132 60,118" fill="#FDF0DC" stroke="#C4720A" stroke-width="2"/><line x1="67" y1="83" x2="78" y2="79" stroke="#C4720A" stroke-width="2"/><line x1="93" y1="83" x2="100" y2="92" stroke="#C4720A" stroke-width="2"/><line x1="62" y1="117" x2="73" y2="129" stroke="#C4720A" stroke-width="2"/><text x="75" y="71" font-size="11" font-family="monospace">H</text><text x="24" y="84" font-size="12" font-family="monospace" fill="#C4412A" font-weight="bold">NO2+</text><line x1="54" y1="83" x2="62" y2="88" stroke="#C4412A" stroke-width="1.5" marker-end="url(#ea2)"/><path d="M 64 86 Q 50 76 42 78" stroke="#0F7B6C" stroke-width="1.5" fill="none" marker-end="url(#ea1)"/><text x="118" y="106" font-size="17" fill="#6B6760">-&gt;</text><text x="146" y="45" font-size="10" fill="#6B6760" font-family="monospace">Arenium ion (not aromatic - sp3 carbon)</text><polygon points="185,92 205,78 225,92 225,118 205,132 185,118" fill="#FAEBE7" stroke="#C4412A" stroke-width="2" stroke-dasharray="4,2"/><text x="200" y="71" font-size="11" font-family="monospace">H</text><line x1="186" y1="97" x2="168" y2="89" stroke="#C4412A" stroke-width="2"/><text x="140" y="92" font-size="12" font-family="monospace" fill="#C4412A">NO2</text><text x="210" y="108" font-size="13" font-family="monospace" fill="#C4412A">+</text><text x="148" y="150" font-size="10" fill="#C4412A" font-family="monospace">sp3 - aromaticity lost!</text><text x="252" y="106" font-size="17" fill="#6B6760">-&gt;</text><text x="278" y="45" font-size="10" fill="#6B6760" font-family="monospace">Step 3: H+ removed, aromaticity restored</text><polygon points="320,92 340,78 360,92 360,118 340,132 320,118" fill="#D4EDE9" stroke="#0F7B6C" stroke-width="2"/><circle cx="340" cy="105" r="12" fill="none" stroke="#0F7B6C" stroke-width="1.5"/><line x1="321" y1="97" x2="303" y2="89" stroke="#0F7B6C" stroke-width="2"/><text x="272" y="92" font-size="12" font-family="monospace" fill="#0F7B6C">NO2</text><text x="370" y="88" font-size="10" font-family="monospace" fill="#6B6760">HSO4-</text><text x="370" y="101" font-size="10" fill="#6B6760" font-family="monospace">takes H+</text><text x="278" y="152" font-size="10" fill="#0F7B6C" font-family="monospace">Nitrobenzene - aromatic again</text><text x="4" y="172" font-size="10" fill="#6B6760" font-family="monospace">Substitution not addition - aromaticity too valuable to lose. H+ expelled to restore ring.</text></svg></div>',
    steps: [
      "HNO3 + H2SO4 generates the nitronium ion (NO2+) — the electrophile. H2SO4 protonates HNO3 which loses water to form linear, electron-poor NO2+.",
      "NO2+ attacks the electron-rich benzene pi system, forming a Wheland intermediate (arenium ion / sigma-complex). One carbon becomes sp3 and aromaticity is temporarily lost. This is the slow, rate-limiting step.",
      "HSO4- removes the proton from the sp3 carbon, restoring the pi system and aromaticity. The driving force is recovery of aromatic stabilisation energy (~150 kJ/mol). Product is nitrobenzene."
    ],
    summary: "HNO3/H2SO4 generates NO2+ which attacks benzene, forming an arenium ion (rate-limiting). Deprotonation restores aromaticity giving nitrobenzene. Always substitution — never addition.",
    clinical: "Nitro groups are reduced in vivo to amines. This is the basis of paracetamol, sulfonamide antibiotics, and many local anaesthetics — all built from aromatic rings modified by nitration then reduction.",
    memory_hook: "Benzene would rather lose a cheap hydrogen than its precious aromaticity. So it substitutes, never adds. The ring is worth protecting at all costs.",
    solution: "EAS nitration: H2SO4 generates NO2+ by protonating HNO3. NO2+ attacks benzene pi electrons forming the arenium ion (rate-limiting, sp3 carbon, non-aromatic Wheland intermediate). Deprotonation by HSO4- restores aromaticity to give nitrobenzene. Substitution is thermodynamically driven by recovery of aromatic resonance stabilisation (~150 kJ/mol)."
  },
  {
    id: "h12",
    title: "Acid chloride reacts with amine to form an amide (peptide) bond",
    ...
    tags: ["acyl substitution", "amide", "acid chloride", "nucleophilic acyl substitution", "peptide bond"],
    emoji: "⚗️",
    clue: "Tags: acyl substitution, amide, acid chloride, peptide bond. A nitrogen nucleophile attacks a highly reactive carbonyl, expelling chloride to form the most stable carbonyl compound — the bond that holds every protein together.",
    diagram: '<div class="mech-diagram"><svg viewBox="0 0 460 155" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block"><defs><marker id="nas1" markerWidth="7" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#0F7B6C"/></marker><marker id="nas2" markerWidth="7" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0,0 L0,6 L7,3 z" fill="#C4412A"/></marker></defs><text x="4" y="13" font-size="10" fill="#6B6760" font-family="monospace">Nucleophilic Acyl Substitution: acid chloride + amine gives amide</text><text x="4" y="50" font-size="12" font-family="monospace">R</text><line x1="16" y1="46" x2="32" y2="46" stroke="#1A1A18" stroke-width="2"/><circle cx="44" cy="46" r="12" fill="#FDF0DC" stroke="#C4720A" stroke-width="1.5"/><text x="38" y="51" font-size="12" font-family="monospace" fill="#C4720A">C</text><line x1="44" y1="34" x2="44" y2="18" stroke="#C4412A" stroke-width="2"/><line x1="49" y1="34" x2="49" y2="18" stroke="#C4412A" stroke-width="2"/><text x="38" y="14" font-size="12" font-family="monospace" fill="#C4412A">O</text><text x="52" y="11" font-size="9" font-family="monospace" fill="#C4412A">d-</text><line x1="56" y1="46" x2="72" y2="46" stroke="#C4412A" stroke-width="2"/><text x="74" y="51" font-size="12" font-family="monospace" fill="#C4412A">Cl</text><text x="40" y="62" font-size="9" font-family="monospace" fill="#C4720A">d+</text><text x="102" y="51" font-size="13" fill="#6B6760">+</text><text x="116" y="51" font-size="12" font-family="monospace" fill="#0F7B6C" font-weight="bold">R-NH2</text><path d="M 125 44 Q 97 28 64 36" stroke="#0F7B6C" stroke-width="1.5" fill="none" marker-end="url(#nas1)"/><text x="160" y="51" font-size="16" fill="#6B6760">-&gt;</text><text x="186" y="13" font-size="10" fill="#6B6760" font-family="monospace">Tetrahedral intermediate</text><text x="186" y="50" font-size="12" font-family="monospace">R</text><line x1="198" y1="46" x2="213" y2="46" stroke="#1A1A18" stroke-width="2"/><circle cx="225" cy="46" r="13" fill="#E8E4F8" stroke="#4A3BAA" stroke-width="2"/><text x="219" y="51" font-size="12" font-family="monospace" fill="#4A3BAA">C</text><line x1="225" y1="33" x2="225" y2="16" stroke="#4A3BAA" stroke-width="2"/><text x="217" y="12" font-size="12" font-family="monospace" fill="#4A3BAA">O-</text><line x1="238" y1="46" x2="255" y2="46" stroke="#C4412A" stroke-width="1.5" stroke-dasharray="3,2"/><text x="257" y="51" font-size="11" font-family="monospace" fill="#C4412A">Cl-</text><line x1="225" y1="59" x2="225" y2="75" stroke="#0F7B6C" stroke-width="2"/><text x="216" y="88" font-size="11" font-family="monospace" fill="#0F7B6C">NHR</text><text x="190" y="108" font-size="10" fill="#4A3BAA" font-family="monospace">sp3 carbon, Cl- leaving</text><text x="300" y="51" font-size="16" fill="#6B6760">-&gt;</text><text x="326" y="13" font-size="10" fill="#6B6760" font-family="monospace">Amide (peptide bond)</text><text x="326" y="50" font-size="12" font-family="monospace">R</text><line x1="338" y1="46" x2="353" y2="46" stroke="#1A1A18" stroke-width="2"/><circle cx="365" cy="46" r="12" fill="#D4EDE9" stroke="#0F7B6C" stroke-width="2"/><text x="359" y="51" font-size="12" font-family="monospace" fill="#0F7B6C">C</text><line x1="365" y1="34" x2="365" y2="18" stroke="#0F7B6C" stroke-width="2"/><line x1="370" y1="34" x2="370" y2="18" stroke="#0F7B6C" stroke-width="2"/><text x="359" y="14" font-size="12" font-family="monospace" fill="#0F7B6C">O</text><line x1="377" y1="46" x2="395" y2="46" stroke="#0F7B6C" stroke-width="2"/><text x="397" y="51" font-size="12" font-family="monospace" fill="#0F7B6C">NHR</text><text x="326" y="72" font-size="10" fill="#0F7B6C" font-family="monospace">resonance-stabilised, planar</text><text x="4" y="130" font-size="10" fill="#6B6760" font-family="monospace">Amide C-N bond has partial double bond character. N lone pair donates into C=O. Very stable and planar.</text><text x="4" y="146" font-size="10" fill="#0F7B6C" font-family="monospace">This IS the peptide bond — backbone of every protein in existence.</text></svg></div>',
    steps: [
      "The amine (R-NH2) lone pair attacks the electrophilic carbonyl carbon of the acid chloride. Cl is an excellent leaving group and withdraws electrons from carbon, making it very electrophilic.",
      "A tetrahedral intermediate forms — carbon is sp3, O becomes O-, NHR and Cl are both attached. The C=O pi bond has broken and oxygen holds the electrons.",
      "Cl- departs as a leaving group, C=O reforms. The N lone pair donates into C=O (resonance), giving the amide partial C=N character. The amide bond is planar, stable, and is the peptide bond found in every protein."
    ],
    summary: "Amine attacks acid chloride carbonyl, tetrahedral intermediate forms, Cl- leaves, amide (peptide bond) produced. N lone pair resonance into C=O makes amide uniquely stable and planar.",
    clinical: "Every protein and peptide drug contains this bond. HIV protease inhibitors (saquinavir) mimic the tetrahedral intermediate to block the enzyme. Beta-lactam antibiotics contain a strained amide ring whose strain drives reactivity with PBPs.",
    memory_hook: "N dives in, Cl leaves, C=O snaps back — but now N is attached and donates back into C=O. The amide is in two minds (C=O or C-N?) and that resonance tension is exactly what makes it so stable.",
    solution: "Nucleophilic acyl substitution: R-NH2 attacks the acid chloride carbonyl (addition generates tetrahedral intermediate with sp3 carbon). Elimination of Cl- restores C=O. The amide product is stabilised by n to pi* resonance (N lone pair delocalised into carbonyl pi*), conferring partial C-N double bond character, planarity, and high stability. This is the peptide bond."
  }
];
